...
public class ECommerce_RemoveItemFromListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Iterator<ShoppingCartLineItem> it = shoppingCart.iterator();
            String[] checkbox1 = request.getParameterValues("delete");
            
            int check = 0;
            
             
                while (it.hasNext()) {
                    ShoppingCartLineItem item = it.next();
                   for (int i = 0; i < checkbox1.length; i++) {
                       if (checkbox1[i].equals(item.getSKU())) {                            
                           it.remove();
                           check++;
                       }                
                }         
...
//            out.println ("z"); 
           String result = "Successfully removed: " + check + " record(s)";
